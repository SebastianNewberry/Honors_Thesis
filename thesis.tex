...
In this conference paper by Springer, the authors of this paper thoroughly studied the censorship of AI by classifying it into soft and hard censorship \parencite{noels_llm_censorship}:
...
\begin{figure}[H]
    ...
    \caption{Censorship and political leaders in LLMs based on }
    \label{fig:2_3}
\end{figure}
